...
/*   Updated: 2026/02/20 13:15:18 by ilaliev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	new_buffer(char *buffer)
{
	char	*new_buf;
	char	*src;
	char	*dest;
...
static char	*join_helper(char *stash, char *buffer)
{
	char	*temp;
...
static char	*buffer_to_stash(int fd, char *stash, char *buffer)
{
	int		buffer_read;
